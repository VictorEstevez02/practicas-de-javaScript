...
function listOfCars(){
    return getCars().forEach((car,index) => {
...
function cars() {
    const lastCar = getCars()[5]
    return console.log(`Ultimo Carro : ${lastCar.brand} ${lastCar.model} ${lastCar.year}`)
